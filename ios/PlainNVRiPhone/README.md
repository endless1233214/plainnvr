...
edge whenever drift grows, so PTZ moves should show up faster on the phone. It
also watches playback progress and automatically reopens the stream if AVPlayer
stalls or stops advancing.
